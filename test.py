...
neural_net = NeuralNetwork.NeuralNetwork([50, 4, 3, 4], seed=0)

history = neural_net.train(X=X, y=y, batch_size=1, epochs=100, learning_rate=0.4, print_every=200, validation_split=0.2,
                           plot_every=10)
print(X_train)
